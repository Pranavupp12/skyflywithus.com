...
export function FlightSpinner({
    ...
    return (
        <div className="flex flex-col items-center justify-center space-y-4 p-8 w-full max-w-3xl">
            ...
            <div className="grid grid-cols-3 gap-4 items-center w-full">
                ...
                <div className="w-42 h-32 mx-auto">
                    <Lottie
            ...
            <ShiningText
                text={statusText}
                className="pt-4 text-2xl" // Pass in original styles
            />
        </div>
    );
}