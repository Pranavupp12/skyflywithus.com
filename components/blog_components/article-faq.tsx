    ...
    return (
        <div className="mx-auto w-full space-y-7">
            <div className="space-y-2">
                <h2 className="text-3xl text-indigo-500 font-semibold md:text-4xl">Frequently Asked Questions</h2>
            ...
            >
                {questions.map((item) => (
                    ...
                    >
                        <AccordionTrigger 
                            className="px-4 py-4 text-[17px] leading-6 hover:no-underline text-left text-indigo-600 dark:text-indigo-400 font-medium"
                        >
