...
export function AboutUsSection() {
  ...
  return (
    <section className="bg-white rounded-2xl mx-auto mt-20 p-10">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col">
          ...
          <h2 className="text-5xl font-regular mb-2 text-gray-900 dark:text-white">
            Built for Sellers,
            <br />
            <span className="text-indigo-500 dark:text-gray-500 font-bold">Backed by Innovation</span>
          </h2>

          {/* Removed Tabs Wrapper */}
          
          {/* Main Paragraph (from "Our Story") */}
          <p className="mt-6 text-lg text-gray-700 dark:text-gray-200 leading-relaxed mb-2">
        ...
        <div className="relative w-full h-[300px] rounded-2xl overflow-hidden shadow-xl">
          <Image
            src="/images/airplane-wing-indigo.png" // Use the placeholder URL defined above
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mt-16 text-center">
        ...
        <div className="flex flex-col items-center">
          <h3 className="text-5xl font-bold text-indigo-500 dark:text-white mb-2">10+</h3>
          <p className="text-gray-600 dark:text-gray-300">Years Experience</p>
        </div>
        {/* Statistic 2 */}
        <div className="flex flex-col items-center">
          <h3 className="text-5xl font-bold text-indigo-500 dark:text-white mb-2">10K+</h3>
          <p className="text-gray-600 dark:text-gray-300">People Trust FlightFareMart</p>
        </div>
        {/* Statistic 3 */}
        <div className="flex flex-col items-center">
          <h3 className="text-5xl font-bold text-indigo-500 dark:text-white mb-2">98 %</h3>
